 ...
 * @param {NodeListOf<Element>} buttons - Collection of all buttons
 */
...
function loadGameContent() {
    ...
    const subjectKey = currentState.subject ? subjectMap[currentState.subject] : null;
    
    if (!currentState.ageGroup || !subjectKey) return;
...
function showCompletionMessage() {
    ...
    requestAnimationFrame(() => {
        const innerDiv = message.querySelector('div > div');
